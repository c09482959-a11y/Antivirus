"""Canonical in-memory timeout sweep ownership.

This module owns the timeout-sweep orchestration boundary.  The specific
queued/assigned/running decisions live in bounded timeout-owned submodules so
this file no longer mixes shared-heartbeat ingestion, start-wait recovery,
running-worker escalation, and immutable result construction in one module.
"""
from __future__ import annotations

from typing import TYPE_CHECKING

from Virus_Scan.scheduler.timeout.inmemory_timeout_sweep_result import InMemoryTimeoutSweepResult
from Virus_Scan.scheduler.timeout.inmemory_timeout_sweep_execution import (
...
def enforce_inmemory_timeout_sweep(
    *,
    state_index: object,
    ...
    """Evaluate timeout/retry state for in-memory worker records."""
    runtime_state = collect_timeout_sweep_runtime_state(
    ...
    return evaluate_timeout_sweep_runtime_state(
...
__all__ = ("InMemoryTimeoutSweepResult", "enforce_inmemory_timeout_sweep")
